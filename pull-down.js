$(function(){
    ...
    // $('#cards-listing > article').stacker();

    // create & innit the left/right carousel object
    var carousel = new Carousel("#carousel");
    carousel.init();

    // create & innit the pull-down to refresh object
    var pulldown = new PullDown("#hitzone");
    pulldown.init();
...
function PullDown(element) {
    ...
    this.init = function() {
        ...
        $element.hammer().on('touch dragdown dragup release', function(ev) {
            self.vertPullHandler(ev);  
        });
    ...
    this.resetMode = function() {
        ...
        $container.removeClass('pulldown-mode').addClass('return');
        pullDownMode = false;
        lockedIn = false;
        offset = 0;
